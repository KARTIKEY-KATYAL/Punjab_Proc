    ...
    <body>
        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				<li class="xn-logo">
					<span style="font-size: 19px; text-align: center; margin: 10px;color:#fff">Uttarakhand State Level</span>
				...
				<li>
					<a style="background-color:#FFC167"><center><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:18px;">Step 2</span></center></a>
				</li>
				
				<li <?php echo ($current_page === 'HomeLeg1.php') ? 'class="active"' : ''; ?>>
					<a href="HomeLeg1.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Step 2.1 Optimise Leg2</span></a>
				</li>
				<li <?php echo ($current_page === 'OptimisedDataLeg1.php') ? 'class="active"' : ''; ?>>
					<a href="OptimisedDataLeg1.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Step 2.2 Optimise Plan Leg2</span></a>
				</li>
				<li <?php echo ($current_page === 'RolloutPlanLeg1.php') ? 'class="active"' : ''; ?>>
					<a href="RolloutPlanLeg1.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Step 2.3 Rollout Plan Leg2</span></a>
				</li>
				...
				<li <?php echo ($current_page === 'DistrictPerformance.php') ? 'class="active"' : ''; ?>>
					<a href="DistrictPerformance.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">District Analysis PC to Mill</span></a>
				</li>
				<li <?php echo ($current_page === 'DistrictPerformance1.php') ? 'class="active"' : ''; ?>>
					<a href="DistrictPerformance1.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">District Analysis Mill to WH</span></a>
				</li>
				...
				<li>
					<a href="PC.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Edit PC</span></a>
				</li>
				<li>
