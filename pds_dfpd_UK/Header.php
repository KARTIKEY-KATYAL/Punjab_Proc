    ...
    <body>
        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				<li class="xn-logo">
					<span style="font-size: 19px; text-align: center; margin: 10px;color:#fff">DFPD dashboard</span>
				...
				<li>
					<a style="background-color:#FFC167"><center><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:18px;">PDS Details</span></center></a>
				</li>
				
				<li <?php echo ($current_page === 'OptimisedDataAll.php') ? 'class="active"' : ''; ?>>
					<a href="OptimisedDataAll.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">PC to MILL Details</span></a>
				</li>
				<li <?php echo ($current_page === 'OptimisedDataAllLeg1.php') ? 'class="active"' : ''; ?>>
					<a href="OptimisedDataAllLeg1.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">MILL to Warehouse Details</span></a>
				</li>
